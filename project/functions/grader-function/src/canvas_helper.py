...
def create_canvas_object(credentials):
    canvas = Canvas(credentials.api_url, credentials.api_key)
    return canvas
...
def upload_grades(canvas_course_id, student_identifier, push_timestamp, assignments_with_grade, credentials):
    # Create a canvas object
    canvas = create_canvas_object(credentials)
    # Get the course
